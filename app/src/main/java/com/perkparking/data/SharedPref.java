...
public class SharedPref {
    ...
    public static final String GCM_PREF_KEY = "com.perkparking.data.GCM_PREF_KEY";
    public static final String SERVER_FLAG_KEY = "com.perkparking.data.SERVER_FLAG_KEY";
    public static final String THEME_COLOR_KEY = "com.perkparking.data.THEME_COLOR_KEY";
    public static final String LAST_PLACE_PAGE = "LAST_PLACE_PAGE_KEY";

    // need refresh
    public static final String REFRESH_PLACES = "com.perkparking.data.REFRESH_PLACES";
